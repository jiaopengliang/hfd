<template>
    <div style="position:fixed; z-index: 0;width: 100%; height: 100%;">
        ...
        <canvas id="canvasbg" width="2000px" height="1000px"></canvas>
    </div>
</template>
<script>
/* eslint-disable */
export default {
  ...
  mounted() {
    ...
    let ctxbg = document.querySelector("#canvasbg").getContext("2d");
    let ctxfr = canvas.getContext("2d");
    // min and max radius, radius threshold and percentage of filled circles
    var radMin = 10,
      radMax = 60,
      filledCircle = 100, //percentage of filled circles
      concentricCircle = 0, //percentage of concentric circles
    ...
    for (var i = 0; i < maxCircles * 2; i++) points.push(new Circle(true));
